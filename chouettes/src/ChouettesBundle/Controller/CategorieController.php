...
use ChouettesBundle\Entity\Categorie;
use ChouettesBundle\Form\CategorieType;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('ChouettesBundle:Categorie')->findAll();

        return $this->render('@Chouettes/Admin/categorie/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ChouettesBundle\Form\CategorieType', $categorie);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('ChouettesBundle\Form\CategorieType', $categorie);
